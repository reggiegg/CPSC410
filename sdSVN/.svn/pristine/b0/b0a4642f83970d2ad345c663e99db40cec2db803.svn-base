...
public class FileTableRow implements FileRow {
  ...
  private static String[] columnNames = {"Status", "Name", "Ext", "Folder", "Committed Revision", "Revision",
                                         "Modified", "Location"};
  private static Class[] columnClass = {String.class, String.class, String.class, File.class, Long.class, Long.class,
  ...
  public static String parseURL(String url, int type) {
    ...
    // last make sure we are on the trunk
  ...
  public boolean isCommitable() {
    boolean fileModified = (status.charAt(0) == 'A') || (status.charAt(0) == 'R') || (status.charAt(0) == '~') ||
                           (status.charAt(0) == 'D') || (status.charAt(0) == 'M') || (status.charAt(0) == 'C');
